...
if __name__ == "__main__":
    ...
    if model == "gpt-35-turbo":  
        ...
        temp_options = st.slider("Choose a temperature:", min_value=0.00, max_value=2.00, step=0.01)
        top_p_options = st.slider("Choose a top p:", min_value=0.00, max_value=1.00, step=0.01)
    elif model == "gpt-4":
        ...
        max_tokens = st.slider("Choose max tokens:", min_value=10, max_value=4000, step=10)
        temp_options = st.slider("Choose a temperature:", min_value=0.00, max_value=1.00, step=0.01)
    else:
        max_tokens = st.slider("Choose max tokens:", min_value=10, max_value=4000, step=10)
